...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        app.post('/products/save',
            ...
            ...(fetchMiddlewares<RequestHandler>(ProductsController.prototype.save)),

            async function ProductsController_save(request: any, response: any, next: any) {
            const args = {
                    products: {"in":"body","name":"products","required":true,"ref":"IProducts"},
            };
            ...
            try {
                ...
                const controller: any = await container.get<ProductsController>(ProductsController);
        ...
        app.get('/products/getById',
            ...(fetchMiddlewares<RequestHandler>(ProductsController)),
            ...(fetchMiddlewares<RequestHandler>(ProductsController.prototype.getById)),

            async function ProductsController_getById(request: any, response: any, next: any) {
            const args = {
        ...
        app.get('/products/get',
            ...
            async function ProductsController_get(request: any, response: any, next: any) {
            const args = {
        ...
        app.get('/products/getAll',
            ...
            async function ProductsController_getAll(request: any, response: any, next: any) {
            const args = {
            };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.delete('/products/deleteById',
            ...(fetchMiddlewares<RequestHandler>(ProductsController)),
            ...(fetchMiddlewares<RequestHandler>(ProductsController.prototype.deleteById)),

            async function ProductsController_deleteById(request: any, response: any, next: any) {
            const args = {
                    id: {"in":"query","name":"id","required":true,"dataType":"string"},
            };
        ...
        app.put('/products/update',
            ...
            async function ProductsController_update(request: any, response: any, next: any) {
            const args = {
                    products: {"in":"body","name":"products","required":true,"ref":"IProducts"},
            };
        ...
        app.post('/user/save',
            ...
            async function UserController_save(request: any, response: any, next: any) {
            const args = {
        ...
        app.get('/user/getAll',
            ...
            async function UserController_getAll(request: any, response: any, next: any) {
            const args = {
            };
        ...
        app.post('/user/login',
            ...
            const args = {
                    user: {"in":"body","name":"user","required":true,"ref":"IUserDTO"},
            };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.delete('/user/deleteById',
            ...(fetchMiddlewares<RequestHandler>(UserController)),
            ...(fetchMiddlewares<RequestHandler>(UserController.prototype.deleteById)),

            async function UserController_deleteById(request: any, response: any, next: any) {
            const args = {
                    id: {"in":"query","name":"id","required":true,"dataType":"string"},
            };
